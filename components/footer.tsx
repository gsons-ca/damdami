    ...
    <footer className="border-t border-slate-200/70 bg-[#fffaf0] px-6 py-10 text-sm text-slate-600 sm:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-xl space-y-3">
          <p className="text-base font-semibold text-[#002366]">Damdami Taksal Canada</p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <p className="font-semibold text-[#002366]">Explore</p>
            <ul className="mt-3 space-y-2 text-slate-700">
              <li>
                <Link href="/history" className="hover:text-[#002366]">
                  History
                </Link>
              </li>
              <li>
                <Link href="/mahopurakh" className="hover:text-[#002366]">
                  Mahapurakh
                </Link>
              </li>
              <li>
                <Link href="/gurbani" className="hover:text-[#002366]">
                  Gurbani & Santhiya
                </Link>
              </li>
            </ul>
          ...
          <div>
            <p className="font-semibold text-[#002366]">Contact</p>
