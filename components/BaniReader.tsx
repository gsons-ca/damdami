  ...
  return (
    <section className="rounded-[2px] border border-slate-200/80 bg-white/90 p-6 shadow-xl shadow-slate-900/5 sm:p-8">
      <div className="flex items-center justify-between gap-4 pb-6 sm:flex-row sm:items-center">
        <div>
          <p className="text-sm uppercase tracking-[0.24em] text-[#002b7a]">Bani Reading</p>
          <h2 className="mt-3 text-3xl font-semibold text-[#002b7a]">Night Mode for Peaceful Study</h2>
        </div>
        <button
          type="button"
          onClick={() => setNightMode(!nightMode)}
          className="inline-flex items-center rounded-[2px] border border-slate-300 bg-[#ff9933]/10 px-4 py-2 text-sm font-medium text-[#002b7a] transition hover:bg-[#ff9933]/15"
        >
      ...
      <div className={`rounded-[2px] border ${nightMode ? "border-slate-700 bg-[#07101b] text-slate-100" : "border-slate-200 bg-[#f9f5ef] text-slate-900"} min-h-[320px] p-6 leading-8 shadow-sm`}>
        <p className="mb-5 text-sm uppercase tracking-[0.3em] text-[#002b7a]/80">Gurbani Sample</p>
